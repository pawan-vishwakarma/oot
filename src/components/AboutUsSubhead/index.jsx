  ...
  return ( 
    <> 
     <div className={props.className}>
        <Img
          className="absolute h-[250px] inset-[0] justify-center m-auto object-cover w-full sm:h-[0px]"
          alt="rectangleThree"
          src={props?.userimage}
        />
        ...
        <div className="absolute bg-white-A700_7f flex flex-col h-full inset-[0] items-center justify-center m-auto w-full">
          ...
          >
            <div className="flex flex-col items-start justify-start mb-[19px] md:ml-[0] ml-[107px] sm:pl-[50px] md:m-[50px]">
              <Text
...
AboutUsSubhead.defaultProps = {
  userimage: "images/img_rectangle3.png",
  homeabouttext: "Home / About",
